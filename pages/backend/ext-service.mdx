...
public class ExtendService extends OriginService {

    @Override
    public void doSomething() { // 重写原有的方法
        // ...
    }
...
@SpringBootApplication(exclude = { SecurityAutoConfiguration.class, OriginService.class }) // 注意这里，屏蔽原有的服务类
